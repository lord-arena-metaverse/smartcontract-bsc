...
export const SUPPORTED_ETHERSCAN_NETWORKS = ['main', 'ropsten', 'kovan', 'bbtest', "bsc"];
...
export const verifyStakeContract = async (
  contractName: string,
  address: string,
  constructorArguments: (string | string[])[],
  pathContract?: string,
  ...
  try {
    ...
    params = {
      ...
      libraries,
      constructorArgs: path,
      contract: "contracts/stake/StakedPoco.sol:StakedPoco",
    };
